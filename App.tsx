...
export default class App extends Component<Props, State> {
    ...
    constructor(props) {
        super(props)
        this.state = {
            appId: '37c719c6fcdf4e48b81817282b7f933e',
            channelName: 'agoraDemo',
            token: '00637c719c6fcdf4e48b81817282b7f933eIABhUpfxMiw8BFVLY/fVHWzT5puTDO7p3rs8E3cQE2hPDFJJTb8AAAAAEACLq5A0PkH1YgEAAQA8QfVi',
            joinSucceed: false,
            peerIds: [],
        }
